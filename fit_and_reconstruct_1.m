...
x_recon = repmat(1.1, 1, 41);
y_recon = [y_hor([1:10, 12:end])  y_ver];
z_recon = [z_hor  z_ver([1:10, 12:end])];
...
[X, Y, outRef, outRecon] = plane_reconstruct(2, 2, 200, pt_srcs, CD_vec, omega, Nmax, temp);
pcolor(X, Y, outRef)
shading flat
title('Reference')
hold on
